...
function loadData(){
  ...
  databaseRef.once("value").then( function(snapshot) {
    ...
    for(i = 0; i < ListaLen; i++){
      dropdown += "<li><a href=\"#"+ i.toString() +"\">"+ Lista[i].nome.toString() +"</a></li>"
    }
    ...
    modali="";
    for(i = 0; i < ListaLen; i++){
      lista += "<tr><td><div class=\"col-md-12\"><div class=\"row\"><h3><a name=\""+ i.toString() +"\"><strong>"+ Lista[i].nome.toString() +"</strong></a></h3></div>"
      ...
      //modali += "<li data-target=\"#carousel-example-generic"+ i.toString() +"\" data-slide-to=\"1\"></li>"
      ...
      //modali += "<div class=\"item\"><img src=\""+ Lista[i].foto[1].toString() +"\" alt=\"Descrizione immagine\" id=\"photo"+ Lista[i].foto[1].toString() +"\"/><div class=\"carousel-caption\"><p>Foto "+ "2" +"</p><button class=\"btn btn-default\" onclick=\"myRotate('photo"+ Lista[i].foto[1].toString() +"')\"><img src=\"rotate_90_degrees_ccw_black_192x192.png\" alt=\"Descrizione immagine\" /></button></div></div>"
